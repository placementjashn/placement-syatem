  ...
  <body>
    ...
    <form action="{{url('/addemp')}}" method="post" enctype="multipart/form-data">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <h1 class="p-4 bg-primary text-white text-center">Add Employee</h1>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <input type="tel" name="phone" value="{{old('phone')}}" placeholder="Enter Contact Number" class="form-control form-group"/>
                </div>
            </div>
