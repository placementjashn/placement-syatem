        ...
        <div class="container">
            ...
            <div class="row form-group">
               ...
               {{--  Company Id --}}
                    ...
                    <input class="form-control" type="hidden" name="company_id" value="{{$job->company_id}}"/>    
                </div>
            </div>
            <div class="row form-group">
                {{-- Job Id --}}
                <div class="col-sm-12">
                   <input class="form-control" type="hidden" name="job_id" value="{{$job->job_id}}" READONLY/>
                </div>
            </div>
            <div class="row form-group">
                <div class="col-sm-12">
            ...
            <div class="row form-group">
                <div class="col-sm-12">
                    Student Name 
                    <input type="text" class="form-control" name="userid" value="{{Auth::User()->name}}" readonly/>
