            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <a href="{{url("/company/dashboard")}}" class="logo">
                        <img src="{{asset("companyCss/assets/images/logo.png")}}" alt="">
                    </a>
                    <!-- ***** Logo End ***** -->
                    <!-- ***** Menu Start ***** -->
                    <ul class="nav">
                        <li><a href="{{url("/company/dashboard")}}">Home</a></li>
                        <li><a href="{{url("/companyabout")}}">About</a></li>
                        <li><a href="{{url("/companydeals")}}" class="active">Deals</a></li>
                        <li><a href="{{url("/companyreservation")}}">Reservation</a></li>
                        <li><a href="{{url("/companyreservation")}}">Book Yours</a></li>
                    </ul>   
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="border-button"><a href="{{url("/companyabout")}}">Discover More</a></div>
        </div>
      </div>
    </div>
  </div>
        ...
        <div class="col-lg-6 col-sm-6">
          <div class="item">
            <div class="row">
              <div class="col-lg-6">
                <div class="image">
                  <img src="{{asset("companyCss/assets/images/deals-01.jpg")}}" alt="">
                </div>
              </div>
        ...
        <div class="col-lg-6 col-sm-6">
          <div class="item">
            <div class="row">
              <div class="col-lg-6">
                <div class="image">
                  <img src="{{asset("companyCss/assets/images/deals-02.jpg")}}" alt="">
                </div>
              </div>
              <div class="col-lg-6 align-self-center">
                <div class="content">
        ...
        <div class="col-lg-6 col-sm-6">
          <div class="item">
            <div class="row">
              <div class="col-lg-6">
                <div class="image">
                  <img src="{{asset("companyCss/assets/images/deals-03.jpg")}}" alt="">
                </div>
              </div>
              <div class="col-lg-6 align-self-center">
                <div class="content">
        ...
        <div class="col-lg-6 col-sm-6">
          <div class="item">
            <div class="row">
              <div class="col-lg-6">
                <div class="image">
                  <img src="{{asset("companyCss/assets/images/deals-04.jpg")}}" alt="">
                </div>
              </div>
              <div class="col-lg-6 align-self-center">
                <div class="content">
