            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <ul class="nav">
                        ...
                        <li><a href="{{url("/companyabout")}}" class="active">About</a></li>
                        <li><a href="{{url("/companydeals")}}">Deals</a></li>
          ...
          <div class="row">
            ...
            <div class="col-lg-12">
              <div class="owl-cites-town owl-carousel">
                <div class="item">
                  <div class="thumb">
                    <img src="{{asset("companyCss/assets/images/cities-01.jpg")}}" alt="">
                    <h4>Havana</h4>
                  </div>
                </div>
                <div class="item">
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="owl-weekly-offers owl-carousel">
            <div class="item">
              <div class="thumb">
                <img src="{{asset("companyCss/assets/images/offers-01.jpg")}}" alt="">
                <div class="text">
            ...
            <div class="item">
              <div class="thumb">
                <img src="{{asset("companyCss/assets/images/offers-02.jpg")}}" alt="">
                <div class="text">
