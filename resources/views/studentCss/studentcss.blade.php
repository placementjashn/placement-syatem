...
<body>
  ...
  <section id="hero" class="hero">
    ...
    <div id="hero-carousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="5000">
      <div class="carousel-item active" style="background-image: url({{asset("studentCss/assets/img/hero-carousel/hero-carousel-1.jpg")}})"></div>
      <div class="carousel-item" style="background-image: url({{asset("studentCss/assets/img/hero-carousel/hero-carousel-3.jpg")}})"></div>
      <div class="carousel-item" style="background-image: url({{asset("studentCss/assets/img/hero-carousel/hero-carousel-4.jpg")}})"></div>
      <div class="carousel-item" style="background-image: url({{asset("studentCss/assets/img/hero-carousel/hero-carousel-5.jpg")}})"></div>
