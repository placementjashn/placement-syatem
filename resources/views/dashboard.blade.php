              ...
              @foreach ($users as $user)
                  ...
                  <nav id="navbar" class="navbar">
                      <ul>
                          ...
                          <li class="dropdown"><a href="#"><img class="rounded-circle" height="45px"
                                      width="45px" src="{{ asset('img/student/' . Auth::user()->image) }}"
      ...
      <section id="hero" class="hero">
          ...
          <div id="hero-carousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="5000">
              <div class="carousel-item active"
                  style="background-image: url({{ asset('studentCss/assets/img/hero-carousel/4.png') }})"></div>
              <div class="carousel-item"
                  style="background-image: url({{ asset('studentCss/assets/img/hero-carousel/2.jpg') }})"></div>
              <div class="carousel-item"
                  style="background-image: url({{ asset('studentCss/assets/img/hero-carousel/3.jpg') }})"></div>
              <div class="carousel-item "
                  style="background-image: url({{ asset('studentCss/assets/img/hero-carousel/5.webp') }})"></div>
                  ...
                  <div class="row">
                    @foreach ($companies as $company)                        
                            <div class="col-xl-6 col-md-6 ">
                                <div class="portfolio-content h-100 overflow-hidden">
                                  @if (file_exists(public_path('img/company/' . $company->image)))                                      
                                    <img src="{{ asset('img/company/' . $company->image) }}"
                                    class="img-fluid " alt="">
                                  @else
                                    <img src="{{ asset('img/company/1678168513.jpeg') }}"
                                    class="img-fluid " alt="">
                                  @endif
                                    <div class="portfolio-info">
                                        <h4>{{ $company->name }}</h4>
                                        <p>{{ $company->description }}</p>
                                        <a href="{{ asset('img/company/' . $company->image) }}"
                                            title="{{ $company->description }}" data-gallery="portfolio-gallery-remodeling"
