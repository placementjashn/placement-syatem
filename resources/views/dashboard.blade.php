        ...
        <body>
          ...
          <form >
              ...
              <ul class="nav nav-tabs">
                  ...
                  <li class="nav-item">
                     <a href="{{url('/appliedstudview')}}" class="nav-link"> Applied Job List </a>
                  </li>
                   <li class="nav-item">
                    <a href="{{url('/compare')}}" class="nav-link"> Comapre Company</a>
                </li>
              </ul>
          </form>
      </body>
...
<body>
        ...
        <ul>
          ...
          <li><div class="hidden sm:flex sm:items-center sm:ml-6">
            <x-dropdown align="right" width="48">
                <x-slot name="trigger">
                    <button>
                        <div><img class="rounded-circle" height="35px" width="35px" src="{{asset('img/student/'.Auth::user()->image)}}" alt="{{ Auth::user()->image }}"></div>
  ...
  <section id="hero" class="hero">
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-6 text-center">
            <h2 data-aos="fade-down">Welcome <span> {{$user->name}} </span></h2>
    ...
    <div id="hero-carousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="5000">
      <div class="carousel-item active" style="background-image: url({{asset("studentCss/assets/img/hero-carousel/it1.jfif")}})"></div>
      <div class="carousel-item" style="background-image: url({{asset("studentCss/assets/img/hero-carousel/it2.jfif")}})"></div>
      <div class="carousel-item" style="background-image: url({{asset("studentCss/assets/img/hero-carousel/student.jfif")}})"></div>
      <div class="carousel-item" style="background-image: url({{asset("studentCss/assets/img/hero-carousel/student2.jpg")}})"></div>
      ...
      <div class="container">
        ...
        <div class="row justify-content-between gy-4">
          ...
          <div class="col-lg-5" data-aos="fade">
            <form action="{{asset("studentCss/forms/quote.blade.php")}}"  method="post" class="php-email-form">
              <h3>Get a quote</h3>
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane active show" id="tab-1">
            <div class="row">
              ...
              <div class="col-lg-6 order-1 order-lg-2 text-center" data-aos="fade-up" data-aos-delay="200">
                <img src="{{asset("studentCss/assets/img/features-1.jpg")}}" alt="" class="img-fluid">
              </div>
            </div>
          ...
          <div class="tab-pane" id="tab-2">
            <div class="row">
              ...
              <div class="col-lg-6 order-1 order-lg-2 text-center">
                <img src="{{asset("studentCss/assets/img/features-2.jpg")}}" alt="" class="img-fluid">
              </div>
            </div>
          </div><!-- End tab content item -->
          ...
          <div class="tab-pane" id="tab-3">
            <div class="row">
              ...
              <div class="col-lg-6 order-1 order-lg-2 text-center">
                <img src="{{asset("studentCss/assets/img/features-3.jpg")}}" alt="" class="img-fluid">
              </div>
            </div>
          </div><!-- End tab content item -->
          ...
          <div class="tab-pane" id="tab-4">
            <div class="row">
              ...
              <div class="col-lg-6 order-1 order-lg-2 text-center">
                <img src="{{asset("studentCss/assets/img/features-4.jpg")}}" alt="" class="img-fluid">
              </div>
            </div>
          </div><!-- End tab content item -->
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-construction">
              <div class="portfolio-content h-100">
                ...
                <div class="portfolio-info">
                  ...
                  <p>Lorem ipsum, dolor sit amet consectetur</p>
                  <a href="{{asset("studentCss/assets/img/projects/construction-1.jpg")}}" title="Construction 1"
